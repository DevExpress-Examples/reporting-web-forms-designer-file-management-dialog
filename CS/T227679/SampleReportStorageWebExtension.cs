...
namespace T227679 {
    public class FileReportStorageWebExtension : DevExpress.XtraReports.Web.Extensions.ReportStorageWebExtension {
        HttpContext _context;

        public FileReportStorageWebExtension(HttpContext context) {
