...
'INSTANT VB NOTE: The field clientInstanceName was renamed since Visual Basic does not allow fields to have the same name as other class members:
		Private clientInstanceName_Conflict As String

		Public Property ClientInstanceName() As String
			Get
				Return If(String.IsNullOrEmpty(clientInstanceName_Conflict), Me.ClientID, Me.clientInstanceName_Conflict)
			End Get
			Set(ByVal value As String)
				Me.clientInstanceName_Conflict = value
			End Set
		End Property

		Public Sub New()
			clientInstanceName_Conflict = Nothing
		End Sub
